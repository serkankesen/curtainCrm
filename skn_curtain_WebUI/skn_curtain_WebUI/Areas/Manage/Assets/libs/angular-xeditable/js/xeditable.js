  ...
  function ($q, editableUtils) {
      ...
      function EditableController($scope, $attrs, $element, $parse, editableThemes, editableOptions, $rootScope, $compile, $q) {
          ...
          self.render = function () {
              ...
              self.inputEl.addClass('editable-input input-sm');
...
angular.module('xeditable').factory('editableThemes', function () {
    var themes = {
        ...
        'bs2': {
            ...
            buttonsTpl: '<span class="editable-buttons"></span>',
            submitTpl: '<button type="submit" class="btn btn-primary btn-sm"><span class="icon-ok icon-white"></span></button>',
            cancelTpl: '<button type="button" class="btn btn-sm" ng-click="$form.$cancel()">' +
        ...
        'bs3': {
            formTpl: '<form class="form-inline editable-wrap" role="form"></form>',
            noformTpl: '<span class="editable-wrap"></span>',
            controlsTpl: '<div class="editable-controls form-group input-sm" ng-class="{\'has-error\': $error}"></div>',
            inputTpl: '',
            errorTpl: '<div class="editable-error help-block" ng-show="$error" ng-bind="$error"></div>',
            buttonsTpl: '<span class="editable-buttons"></span>',
            submitTpl: '<button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-check"></i></button>',
            cancelTpl: '<button type="button" class="btn default btn-sm" ng-click="$form.$cancel()">' +
